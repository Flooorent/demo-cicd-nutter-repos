...
experiment_name = "/Users/florent.moiny@databricks.com/demo/cicd/using-nutter/experiments/v3"
...
X_train, X_test, y_train, y_test = train_test_split(
  data.drop(["quality"], axis=1), data[["quality"]].values.ravel(), random_state=42
)
